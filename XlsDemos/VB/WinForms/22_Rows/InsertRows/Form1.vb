...
Namespace Spire.Xls.Sample
	...
	Public Class Form1
		...
		Private Sub InitializeComponent()
            ...
            Me.label1.Text = "The sample demonstrates how to insert rows into an excel workbook and copy data a" & _
                "nd" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "styles from existing cells."
            '
            'Form1
            '
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
            ...
            sheet.InsertRow(2)
            sheet.Copy(sheet.Range("A1:E1"), sheet.Range("A2:E2"), True)
            sheet.InsertRow(5, 2)
            sheet.Copy(sheet.Range("A3:E4"), sheet.Range("A5:E6"), True)
