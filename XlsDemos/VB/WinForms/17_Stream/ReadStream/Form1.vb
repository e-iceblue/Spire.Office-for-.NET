...
Namespace Spire.Xls.Sample
	...
	Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' btnRun
			' 
			Me.btnRun.Location = New System.Drawing.Point(384, 56)
...
'			Me.btnRun.Click += New System.EventHandler(Me.btnRun_Click);
			...
			' btnAbout
			' 
			Me.btnAbout.Location = New System.Drawing.Point(464, 56)
...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Text = "The sample demonstrates how to  load an excel workbook from stream."
			' 
			' Form1
			' 
			Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
			Me.ClientSize = New System.Drawing.Size(576, 101)
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
            ...
            Dim fileStream As FileStream = File.OpenRead("..\..\..\..\..\..\Data\ReadStreamSample.xls")
