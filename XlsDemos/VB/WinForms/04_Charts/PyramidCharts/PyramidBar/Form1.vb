...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Size = New System.Drawing.Size(508, 18)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to create pyramid bar chart in an excel workbook."
			' 
			' checkBox1
			' 
			...
			Me.checkBox1.Text = "Stacked bar chart"
			' 
			' Form1
			' 
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
			...
			If checkBox1.Checked Then
				...
				CreateStackedChart(sheet, chart)
				chart.ChartType = ExcelChartType.PyramidBarStacked
			Else
				CreateChartData(sheet)
				CreateChart(sheet, chart)
				chart.ChartType = ExcelChartType.PyramidBarClustered
			End If
		...
		Private Sub CreateStackedChart(ByVal sheet As Worksheet, ByVal chart As Chart)
		...
		Private Sub CreateChart(ByVal sheet As Worksheet, ByVal chart As Chart)
			...
			chart.Series(0).CategoryLabels = sheet.Range("A2:A5")
		End Sub
		...
		Private Sub CreateStackedChartData(ByVal sheet As Worksheet)
			'Country
