...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Size = New System.Drawing.Size(587, 18)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to create percent stacked pyramid chart in an excel w" & "orkbook."
			' 
			' checkBox1
			' 
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
			...
			If checkBox1.Checked Then
				chart.ChartType = ExcelChartType.PyramidBar100PercentStacked
				chart.PrimaryCategoryAxis.TitleArea.TextRotationAngle = 90


			Else
				chart.ChartType = ExcelChartType.Pyramid100PercentStacked
