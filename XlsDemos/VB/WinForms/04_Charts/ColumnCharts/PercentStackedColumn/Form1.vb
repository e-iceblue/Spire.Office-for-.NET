...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Text = "The sample demonstrates how to create 100%  stacked column chart in an excel work" & "book."
			' 
			' checkBox1
			' 
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
			...
			If checkBox1.Checked Then
				chart.ChartType = ExcelChartType.Column3D100PercentStacked
			Else
				chart.ChartType = ExcelChartType.Column100PercentStacked
			End If
