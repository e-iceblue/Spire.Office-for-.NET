...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Size = New System.Drawing.Size(498, 18)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to create chart worksheet in an excel workbook."
			' 
			' Form1
			' 
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
			...
			Dim chartsheet As ChartSheet = workbook.Charts.Add("chart worksheet")
            ...
            For Each cs As Charts.ChartSerie In chartsheet.Series
