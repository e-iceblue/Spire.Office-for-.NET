...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
		...
		Private Sub CreateChartData(ByVal sheet As Worksheet)
			Dim RCAddress As String = "A{0}:D{0}"
			'Volume
			...
			'High
			sheet.Range("B1").Value = "High"
			sheet.Range("B2").NumberValue = 47
			sheet.Range("B3").NumberValue = 49
			sheet.Range("B4").NumberValue = 45
			sheet.Range("B5").NumberValue = 48
			sheet.Range("B6").NumberValue = 51
			sheet.Range("B7").NumberValue = 55
			sheet.Range("B8").NumberValue = 56

			'Low
			sheet.Range("C1").Value = "Low"
			sheet.Range("C2").NumberValue = 38
			sheet.Range("C3").NumberValue = 40
			sheet.Range("C4").NumberValue = 41
			sheet.Range("C5").NumberValue = 40
			sheet.Range("C6").NumberValue = 45
			sheet.Range("C7").NumberValue = 49
			sheet.Range("C8").NumberValue = 50

			'Close
			sheet.Range("D1").Value = "Close"
			sheet.Range("D2").NumberValue = 42
			sheet.Range("D3").NumberValue = 45
			sheet.Range("D4").NumberValue = 44
			sheet.Range("D5").NumberValue = 48
			sheet.Range("D6").NumberValue = 59
			sheet.Range("D7").NumberValue = 53
			sheet.Range("D8").NumberValue = 51
			...
			'Border
			sheet.Range("A1:D8").Style.Borders(BordersLineType.EdgeTop).Color = Color.FromArgb(0, 0, 128)
			sheet.Range("A1:D8").Style.Borders(BordersLineType.EdgeTop).LineStyle = LineStyleType.Thin
			sheet.Range("A1:D8").Style.Borders(BordersLineType.EdgeBottom).Color = Color.FromArgb(0, 0, 128)
			sheet.Range("A1:D8").Style.Borders(BordersLineType.EdgeBottom).LineStyle = LineStyleType.Thin
			sheet.Range("A1:D8").Style.Borders(BordersLineType.EdgeLeft).Color = Color.FromArgb(0, 0, 128)
			sheet.Range("A1:D8").Style.Borders(BordersLineType.EdgeLeft).LineStyle = LineStyleType.Thin
			sheet.Range("A1:D8").Style.Borders(BordersLineType.EdgeRight).Color = Color.FromArgb(0, 0, 128)
			sheet.Range("A1:D8").Style.Borders(BordersLineType.EdgeRight).LineStyle = LineStyleType.Thin

			sheet.Range("B2:D8").Style.NumberFormat = """$""#,##0"
		End Sub
