...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Size = New System.Drawing.Size(547, 18)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to create 100% stacked bar chart in an excel workbook" & "."
			' 
			' checkBox1
			' 
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
			...
			If checkBox1.Checked Then
				chart.ChartType = ExcelChartType.Bar3D100PercentStacked
			Else
				chart.ChartType = ExcelChartType.Bar100PercentStacked
			End If
