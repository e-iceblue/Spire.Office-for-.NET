...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Size = New System.Drawing.Size(487, 18)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to create cone bar chart in an excel workbook."
			' 
			' Form1
			' 
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
			...
			chart.ChartType = ExcelChartType.ConeBarClustered
