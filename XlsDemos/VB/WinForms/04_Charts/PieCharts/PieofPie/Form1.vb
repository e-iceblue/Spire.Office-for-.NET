...
'            Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
            ...
            Me.label1.Text = "The sample demonstrates how to create a pie of pie chart in an excel workbook."
            '
            ' Form1
            '
        ...
        Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
            ...
            Dim chart As Chart = sheet.Charts.Add(ExcelChartType.PieOfPie)
