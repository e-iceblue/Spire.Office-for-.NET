...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Size = New System.Drawing.Size(558, 18)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to create percent stacked line chart in an excel work" & "book."
			' 
			' checkBox1
			' 
			...
			Me.checkBox1.Text = "Stacked markers chart"
			' 
			' Form1
			' 
