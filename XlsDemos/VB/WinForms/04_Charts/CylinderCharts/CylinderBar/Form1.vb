...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Size = New System.Drawing.Size(510, 18)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to create cylinder  bar chart in an excel workbook."
			'
			' checkBox1
			'
		...
		Private Sub CreateStackedColumnChart(ByVal sheet As Worksheet, ByVal chart As Chart)
		...
		Private Sub CreateColumnChart(ByVal sheet As Worksheet, ByVal chart As Chart)
			'Set region of chart data
