...
Namespace Spire.Xls.Sample
	...
	Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' btnRun
			' 
			Me.btnRun.Location = New System.Drawing.Point(448, 48)
...
'			Me.btnRun.Click += New System.EventHandler(Me.btnRun_Click);
			...
			' btnAbout
			' 
			Me.btnAbout.Location = New System.Drawing.Point(528, 48)
...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Size = New System.Drawing.Size(464, 18)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to  read an excel workbook from a xml file."
			' 
			' Form1
			' 
			Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
			Me.ClientSize = New System.Drawing.Size(616, 85)
        ...
        Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
            ...
            Using fileStream As FileStream = File.OpenRead("..\..\..\..\..\..\Data\ReadXMLSample.Xml")
