...
Namespace Spire.Xls.Sample
	...
	Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' btnRun
			' 
			Me.btnRun.Location = New System.Drawing.Point(312, 64)
...
'			Me.btnRun.Click += New System.EventHandler(Me.btnRun_Click);
			...
			' btnAbout
			' 
			Me.btnAbout.Location = New System.Drawing.Point(392, 64)
...
'			Me.btnAbout.Click += New System.EventHandler(Me.btnAbout_Click);
			...
			Me.label1.Size = New System.Drawing.Size(480, 18)
			Me.label1.TabIndex = 4
			Me.label1.Text = "The sample demonstrates how to  Unlock a worksheet in an excel workbook."
			' 
			' Form1
			' 
			Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
			Me.ClientSize = New System.Drawing.Size(488, 93)
		...
		Private Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
			...
			workbook.LoadFromFile("..\..\..\..\..\..\Data\UnProtectSample.xls")
			Dim sheet As Worksheet = workbook.Worksheets(0)

			'Protect workshet
			sheet.Unprotect("LockTest")
