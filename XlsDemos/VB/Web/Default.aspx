<%@ Page language="vb" AutoEventWireup="false" Inherits="Spire.WebDemo.DefaultForm" uiCulture="en-US" CodeFile="Default.aspx.vb" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<asp:button id="Button1" style="Z-INDEX: 100; LEFT: 600px; POSITION: absolute; TOP: 296px" runat="server"
				Width="96px" Text="Run"></asp:button>
			<asp:label id="Label1" style="Z-INDEX: 110; LEFT: 72px; POSITION: absolute; TOP: 168px" runat="server"
				Width="680px" Height="40px" ForeColor="Blue">For more detailed usage of Spire.XLS, run SampleCenter to view more samples.</asp:label>
			<asp:Label id="Label6" style="Z-INDEX: 108; LEFT: 80px; POSITION: absolute; TOP: 224px" runat="server"
				...
				Width="656px" ForeColor="Blue" Height="40px"> Notes : Not needing to have Microsoft Excel installed on the machine,The Spire.XLS can read/write Excel spreadsheet .</asp:label><asp:hyperlink id="HyperLink1" style="Z-INDEX: 101; LEFT: 88px; POSITION: absolute; TOP: 256px"
				...
				Width="464px" Height="24px" Font-Bold="True" Font-Size="Large"> Spire.XLS for .NET</asp:label>
