...
namespace Spire.Xls.Sample
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "The sample demonstrates how to create surface chart in an excel workbook.";
			// 
			// Form1
			// 
		...
		private void btnRun_Click(object sender, System.EventArgs e)
		{
			...
			chart.ChartType = ExcelChartType.SurfaceContour;
		...
		private void CreateChart(Worksheet  sheet, Chart chart)
		{
			...
			//Chart title
			chart.ChartTitle = "Surface chart";
