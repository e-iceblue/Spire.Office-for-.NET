...
namespace Spire.Xls.Sample
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "The sample demonstrates how to create scatter chart in an excel workbook.";
			// 
			// Form1
			// 
		...
		private void CreateChartData(Worksheet sheet)
		{
			...
			sheet.Range["A2"].NumberValue = 40;
			sheet.Range["A3"].NumberValue = 33;
			sheet.Range["A4"].NumberValue = 78;
			sheet.Range["A5"].NumberValue = 34;
			sheet.Range["A6"].NumberValue = 70;
			sheet.Range["A7"].NumberValue = 62;
			sheet.Range["A8"].NumberValue = 61;
			sheet.Range["A9"].NumberValue = 33;
			sheet.Range["A10"].NumberValue = 32;
			sheet.Range["A11"].NumberValue = 34;
			sheet.Range["A12"].NumberValue = 29;
                                                   
			//Reflex Time
			sheet.Range["B1"].Value = "Reflex Time";
			sheet.Range["B2"].NumberValue = 0.37; 
			sheet.Range["B3"].NumberValue = 0.43; 
			sheet.Range["B4"].NumberValue = 0.076;
			sheet.Range["B5"].NumberValue = 0.41 ;
			sheet.Range["B6"].NumberValue = 0.13 ;
			sheet.Range["B7"].NumberValue = 0.17 ;
			sheet.Range["B8"].NumberValue = 0.19 ;
			sheet.Range["B9"].NumberValue = 0.43 ;
			sheet.Range["B10"].NumberValue =0.45 ;
			sheet.Range["B11"].NumberValue =0.38 ;
			sheet.Range["B12"].NumberValue =0.46 ;
