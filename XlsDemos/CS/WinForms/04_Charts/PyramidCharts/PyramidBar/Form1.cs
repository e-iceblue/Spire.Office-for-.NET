...
namespace Spire.Xls.Sample
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "The sample demonstrates how to create pyramid bar chart in an excel workbook.";
			// 
			// checkBox1
			// 
			...
			this.checkBox1.Text = "Stacked bar chart";
			// 
			// Form1
			// 
		...
		private void CreateStackedChart(Worksheet sheet, Chart chart)
		{
		...
		private void CreateStackedChartData(Worksheet sheet)
		{
			//Country
