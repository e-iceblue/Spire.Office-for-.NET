...
namespace Spire.Xls.Sample
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnRun
			// 
			this.btnRun.Location = new System.Drawing.Point(448, 104);
			...
			// btnAbout
			// 
			this.btnAbout.Location = new System.Drawing.Point(528, 104);
			...
			this.label1.Text = "The sample demonstrates how to  usage of VBA in an excel workbook.";
			// 
			// textBox1
			// 
			...
			this.label2.Text = "Input new sheet name :";
			// 
			// Form1
			// 
