...
namespace Spire.Xls.Sample
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// btnRun
			// 
			this.btnRun.Location = new System.Drawing.Point(312, 120);
			...
			// btnAbout
			// 
			this.btnAbout.Location = new System.Drawing.Point(392, 120);
			...
			this.label1.Text = "The sample demonstrates how to  lock a worksheet in an excel workbook.";
			// 
			// label2
			// 
			...
			this.textBox1.Text = "LockTest";
			// 
			// linkLabel1
			// 
			this.linkLabel1.Location = new System.Drawing.Point(18, 40);
			this.linkLabel1.Name = "linkLabel1";
			this.linkLabel1.Size = new System.Drawing.Size(440, 32);
			this.linkLabel1.TabIndex = 7;
			this.linkLabel1.TabStop = true;
			this.linkLabel1.Text = "Unprotect worksheet, Select Tools>Protection/Unprotect Sheet and type in the pass" +
				"word. ";
			// 
			// Form1
			// 
