...
Namespace PdfViewer_Print
	...
	Partial Public Class MainWindow
		...
		Private Sub btnPrint_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
			...
			dialog.MaxPage = If(Me.pdfViewer1.PageCount > 0, CUInt(Me.pdfViewer1.PageCount), 1)
			dialog.MinPage = 1
			...
			If result.Value Then
				Try
					...
					Me.pdfViewer1.PrintDialog = dialog
		...
		Private Sub Window_Loaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
			Try
				' Load pdf document from file.
				Me.pdfViewer1.LoadFromFile("..\..\..\..\..\..\Data\PartList.pdf")
			Catch ex As Exception
				MessageBox.Show(ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Error)
			End Try
		End Sub
