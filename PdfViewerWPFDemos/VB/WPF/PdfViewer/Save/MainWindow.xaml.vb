...
Namespace PdfViewer_Save
	...
	Partial Public Class MainWindow
		...
		Private Sub btnOpen_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
			'Open a Pdf Document
		  Dim a As String= System.IO.Path.GetFullPath("..\..\..\..\..\..\Data")
		...
		Private Sub btnSave_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
			...
			If result.Value Then
				Try
					'Save PDF documetns.
					pdfViewer1.SaveToFile(savefile.FileName)
				Catch ex As Exception
					MessageBox.Show(ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Error)
				End Try
			End If
		...
		Private Sub Window_Loaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
			Try
				...
				Me.pdfViewer1.LoadFromFile("..\..\..\..\..\..\Data\Open Education.pdf")
			Catch ex As Exception
				MessageBox.Show(ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Error)
			End Try
		End Sub
