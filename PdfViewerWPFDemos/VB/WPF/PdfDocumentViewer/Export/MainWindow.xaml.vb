...
Namespace PdfDocumentViewer_Export
	...
	Partial Public Class MainWindow
		...
		Private Sub pdfDocumentViewer1_PageNumberChanged(ByVal sender As Object, ByVal args As EventArgs)
			textBox1.Text = Me.pdfDocumentViewer1.CurrentPageNumber.ToString()
		End Sub
			...
			Try
				...
				ElseIf ckbFrom.IsChecked.Value AndAlso (Not ckbTo.IsChecked.Value) Then
					Try
						...
						Dim bitmapsource As BitmapSource = Me.pdfDocumentViewer1.SaveAsImage(currepageIndex)
		...
		Private Sub btnOpen_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
			'Open a Pdf Document
			Dim dialog As OpenFileDialog = New OpenFileDialog With {.Filter = "PDF files *.pdf|*.pdf", .Title = "Select a PDF file", .Multiselect = False, .InitialDirectory =System.IO.Path.GetFullPath("..\..\..\..\..\..\Data")}
			...
			If boolVar.Value Then
				Try
					...
					Me.textBox2.Text = Me.pdfDocumentViewer1.PageCount.ToString()
				Catch ex As Exception
					MessageBox.Show(ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Error)
				End Try
			End If
		...
		Private Sub WriteBitmapSourecToFile(ByVal bitMapImg As BitmapSource, ByVal currentPageIndex As Integer)
			Try
				If bitMapImg IsNot Nothing Then
					...
					Dim filename As String = System.IO.Path.GetFileNameWithoutExtension(Me.pdfDocumentViewer1.FileName)
...
#End If
		...
		Private Sub Window_Loaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
			Try
				' Load pdf document from file.
				Me.pdfDocumentViewer1.LoadFromFile("..\..\..\..\..\..\Data\Open Education.pdf")
				Me.textBox2.Text = Me.pdfDocumentViewer1.PageCount.ToString()
			Catch ex As Exception
				MessageBox.Show(ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Error)
			End Try
