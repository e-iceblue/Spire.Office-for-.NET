...
'		}
		...
		Friend ReadOnly Property ToDoc() As Bitmap
			Get
				Dim obj As Object = ResourceManager.GetObject("ToDoc", resourceCulture)
				Return (CType(obj, Bitmap))
			End Get
		End Property

		Friend ReadOnly Property ToDocx() As Bitmap
			Get
				Dim obj As Object = ResourceManager.GetObject("ToDocx", resourceCulture)
				Return (CType(obj, Bitmap))
			End Get
		End Property

		Friend ReadOnly Property ToPdf() As Bitmap
			Get
				Dim obj As Object = ResourceManager.GetObject("ToPdf", resourceCulture)
				Return (CType(obj, Bitmap))
			End Get
		End Property
	End Module
