Namespace Print
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.btnPrint = New ToolStripButton()
			...
			Me.toolStrip1.Items.AddRange(New ToolStripItem() { Me.btnOpen, Me.btnClose, Me.toolStripSeparator1, Me.btnPrint})
			...
			Me.btnOpen.ToolTipText = "Open from File"
...
'			Me.btnClose.Click += New System.EventHandler(Me.btnClose_Click)
			...
			' btnPrint
			' 
			Me.btnPrint.DisplayStyle = ToolStripItemDisplayStyle.Image
			Me.btnPrint.Image = My.Resources.Print
			Me.btnPrint.ImageTransparentColor = Color.Magenta
			Me.btnPrint.Name = "btnPrint"
			Me.btnPrint.Size = New Size(36, 36)
...
'			Me.btnPrint.Click += New System.EventHandler(Me.btnPrint_Click)
			...
			Me.Text = "Spire.DocViewer for .NET - Demo – Print Doc via DocDocumentViewer Component."
